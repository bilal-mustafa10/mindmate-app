...
export default function ActivityCompleted({ navigation }: RootStackScreenProps<'ActivityCompleted'>) {
    ...
    return (
        <View style={[styles.container, {paddingTop: insets.top}]}>
            <View style={[styles.content, styles.primaryBackground, { height: height * 0.60 }]}>
                <FastImage source={require('../../assets/images/activity-completed.png')} style={styles.activityLogo} />
                <Text style={styles.title}>Congratulations!</Text>
                <Text style={[theme.typography.body1, {textAlign:'center'}]}>You have successfully completed the activity. Thank you for taking the time to participate and engage in this activity.</Text>
            </View>
            <View
                style={{
                    position: 'absolute',
