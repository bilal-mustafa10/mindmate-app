    ...
    return (
        <View style={[styles.container, {paddingTop: insets.top}]}>
            <View style={[styles.content, styles.primaryBackground, { height: height * 0.65 }]}>
                ...
                <Text style={[theme.typography.bodyMedium, {textAlign:'center', marginVertical:'10%'}]}>You have successfully completed the activity. Thank you for taking the time to participate and engage in this activity.</Text>
            </View>
            <View
                style={{
                    position: 'absolute',
